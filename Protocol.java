...
public class Protocol {
	...
	public final static String JOINED_COMPLETE_TOKEN = "JOINED_COMPLETE";
	...
	// Message for the error loggers
	public final static String MALFORMED_ERROR = "Malformed message received";
}
